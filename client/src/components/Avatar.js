...
export const Avatar = () => {
  return (
    <div className="flex flex-col items-center gap-2">
      <div className="w-16 h-16 rounded-full bg-purple-200 flex items-center justify-center border-2 border-white/20 shadow-lg relative overflow-hidden">
         {/* Simple Bot Face SVG */}
         <svg
  viewBox="0 0 122.88 105.21"
  className="w-10 h-10 text-white fill-current" // Adjusted size/color to fit your container
>
  <g>
    <path
      fillRule="evenodd"
    ...
    />
      ...
      <span className="text-orange-500 font-bold text-lg tracking-wide">COSBIA Bot</span>
    </div>
  );
};